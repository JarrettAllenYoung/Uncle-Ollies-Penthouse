...
function initScreenAnd3D() {
  ...
  // Uncomment the following if OrbitControls are desired:
  /*
...
// UPDATE GEOMETRY: Replace CubeGeometry with BoxGeometry and applyMatrix with applyMatrix4
...
Hero = function() {
  ...
  // Adjust ear vertices as in your original code
...
Monster = function(){
  ...
  var torsoGeom = new THREE.BoxGeometry(15, 15, 20, 1, 1, 1);
  this.torso = new THREE.Mesh(torsoGeom, blackMat);
  
  var headGeom = new THREE.BoxGeometry(20, 20, 40, 1, 1, 1);
  ...
  var mouthGeom = new THREE.BoxGeometry(10, 4, 20, 1, 1, 1);
  ...
  var toothGeom = new THREE.BoxGeometry(2, 2, 1, 1, 1, 1);
  ...
  var tongueGeometry = new THREE.BoxGeometry(6, 1, 14, 1, 1, 1);
  ...
  var noseGeom = new THREE.BoxGeometry(4, 4, 4, 1, 1, 1);
  ...
  var eyeGeom = new THREE.BoxGeometry(2, 3, 3, 1, 1, 1);
  this.eyeL = new THREE.Mesh(eyeGeom, whiteMat);
  this.eyeL.position.set(10, 5, 5);
  this.eyeL.castShadow = true;
  this.head.add(this.eyeL);
  
  var irisGeom = new THREE.BoxGeometry(0.6, 1, 1, 1, 1, 1);
  this.iris = new THREE.Mesh(irisGeom, blackMat);
  this.iris.position.set(1.2, -1, 1);
  this.eyeL.add(this.iris);
  ...
  var earGeom = new THREE.BoxGeometry(8, 6, 2, 1, 1, 1);
  ...
  var eyeGeom2 = new THREE.BoxGeometry(2, 4, 4, 1, 1, 1);
  ...
  var pawGeom = new THREE.CylinderGeometry(1.5, 0, 10, 1);
...
// (Additional code for Carrot, Hedgehog, etc., remains as defined above with updates.)
// In your full file, ensure that any remaining instances of CubeGeometry or applyMatrix are updated accordingly.

//
// NOTE: Your code for Carrot, Hedgehog, and additional models should be updated similarly.
// If you have defined Carrot and Hedgehog in your original file using CubeGeometry, they should be replaced with BoxGeometry and applyMatrix4 as done above for Hero and Tree/Trunc.
//
...
// };
//
// Then update accordingly (if needed). Since your pasted code for Carrot and Hedgehog already used CubeGeometry, make sure they are updated as shown in the Hero update.
//
// The rest of your code (collision checking, animation loop, UI, event handlers, etc.) remains unchanged.
